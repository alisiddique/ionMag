...
$buffy .= '<div class="td-footer-extra-column">';

    // logo
    $buffy .= '<aside class="footer-logo-wrap">';
    ...
    // description
    $buffy .= '<aside class="footer-text-wrap">';
    ...
    // social icons
    $buffy .= '<aside class="footer-social-wrap td-social-style-2">';
